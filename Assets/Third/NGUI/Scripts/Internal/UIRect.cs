...
public abstract class UIRect : MonoBehaviour
{
    ...
    [System.NonSerialized] bool mHasUpdateAnchorsInternalCached = false;
	...
	protected virtual void OnEnable ()
	{
		...
		if (mStarted) OnInit();
		mUpdateFrame = -1;
        mHasUpdateAnchorsInternalCached = false;
    }
	...
	public void Update ()
	{
        ...
        doUpdate = (mUpdateFrame != frame || !Application.isPlaying);
#else
        doUpdate = (mUpdateFrame != frame);
#endif
        ...
        if(doUpdate)
        {
            ...
            {
                if(!mHasUpdateAnchorsInternalCached)
                {
                    UpdateAnchorsInternal(frame);
                    mHasUpdateAnchorsInternalCached = true;
                }
            }
			OnUpdate();
		}
