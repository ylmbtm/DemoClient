...
namespace MAP
{
    ...
    {
        [MAPFieldAttri] public string                 Name = string.Empty;
        [MAPFieldAttri] public int                    DestMapID;
        [MAPFieldAttri] public Vector3                DestPos;
        [MAPFieldAttri] public EOpenConditionRelation OpenConditionRelation;
        [MAPFieldAttri] public int                    OpenLevel;
        [MAPFieldAttri] public int                    OpenItemID;
        [MAPFieldAttri] public int                    OpenVIP;
        ...
        public override void OnDrawGizmos()
        {
            ...
            EDraw.DrawGizmosCube(transform.position + new Vector3(0, 2, 0), transform.rotation, transform.localScale, new Color32(51, 163, 237, 255), Vector3.one);
        }
