...
namespace MAP
{
    public class MAPWorldMap : MonoBehaviour
    {
        ...
        public void TriggerElement<T>(int id) where T : MAPElement
        {
        ...
        public void ReleaseElement<T>(int id) where T : MAPElement
        {
            MAPGroup<T> g = GetGroup<MAPGroup<T>>();
            if (g == null)
            {
        ...
        public void ExportTo<MapElem, DtElem>(List<DtElem> DtElemList)  where MapElem : MAPElement where DtElem : DTElement
        {
        ...
        public void ImportFrom<MapElem, DtElem>(List<DtElem> DtElemList) where MapElem : MAPElement  where DtElem : DTElement
        {
        ...
        public void Import()
        {
            ...
            this.AddGroups();
            string fileName = string.Format("Text/Map/{0}", this.MapID);
            DTMap data  = new DTMap();
            data.Load(fileName);
