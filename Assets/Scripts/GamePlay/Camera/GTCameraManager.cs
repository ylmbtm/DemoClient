...
public class GTCameraManager : GTMonoSingleton<GTCameraManager>
{
    ...
    public GTCameraFollow   CameraCtrl    { get; private set; }
    ...
    public void CreateMainCamera()
    {
        ...
        this.CameraCtrl = mFreeLook.GET<GTCameraFollow>();
    }
    ...
    public void CreateCameraEffect(int id, Action onFinish)
    {
    ...
    void CreateUIRoot()
    {
        ...
        NGUICamera.nearClipPlane = -100000;
        ...
        mAnchor = mRoot.gameObject.AddChild(mRoot.gameObject.layer).transform;
