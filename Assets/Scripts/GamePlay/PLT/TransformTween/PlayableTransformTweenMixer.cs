...
namespace PLT
{
    public class PlayableTransformTweenMixer : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            {
                ScriptPlayable<PlayableTransformTween> playableInput = (ScriptPlayable<PlayableTransformTween>)playable.GetInput(i);
                PlayableTransformTween input = playableInput.GetBehaviour();
