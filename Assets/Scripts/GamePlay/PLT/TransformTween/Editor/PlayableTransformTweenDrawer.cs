...
namespace PLT
{
    [CustomPropertyDrawer(typeof(PlayableTransformTween))]
    public class PlayableTransformTweenDrawer : PropertyDrawer
    {
        ...
        {
            int fieldCount = property.FindPropertyRelative("tweenType").enumValueIndex == (int)PlayableTransformTween.TweenType.Custom ? 5 : 3;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (tweenTypeProp.enumValueIndex == (int)PlayableTransformTween.TweenType.Custom)
            {
