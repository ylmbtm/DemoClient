...
namespace PLT
{
    public sealed class PlayableVideoSchedulerBehaviour : PlayableBehaviour
    {
        ...
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            {
				ScriptPlayable<PlayableVideo> scriptPlayable =
					(ScriptPlayable<PlayableVideo>)playable.GetInput(inputPort);

				PlayableVideo videoPlayableBehaviour = scriptPlayable.GetBehaviour();
