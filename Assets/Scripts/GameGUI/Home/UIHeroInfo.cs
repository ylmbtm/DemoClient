...
public class UIHeroInfo : GTWindow
{
    ...
    {
        GTEventCenter.AddHandler(GTEventID.TYPE_TICK_SECOND, ShowActionView);
    ...
    {
        GTEventCenter.DelHandler(GTEventID.TYPE_TICK_SECOND, ShowActionView);
...
//             mv.moneyNumText.text = GTData.Instance.GetItemCountById(db.Id).ToString();
//         }
// 
...
//         int fightValue = GTAttrHelper.GetFightValueForLocalPlayer(role);
...
//         int curNum1 = GTData.Instance.GetItemCountById(101);
//         int curNum2 = GTData.Instance.GetItemCountById(102);
...
// 
//         string oneTimer1 = GTData.Instance.GetOneSecondTimer(101);
//         string oneTimer2 = GTData.Instance.GetOneSecondTimer(102);
//         string allTimer1 = GTData.Instance.GetAllSecondTimer(101);
//         string allTimer2 = GTData.Instance.GetAllSecondTimer(102);
// 
