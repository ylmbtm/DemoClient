...
public class UIRole : GTWindow
{
    ...
    protected override void OnAddHandler()
    {
        ...
        GTEventCenter.AddHandler<string>(GTEventID.TYPE_LOGIN_RANDOM_NAME, OnRecvRandomName);
    }
    ...
    protected override void OnDelHandler()
    {
        ...
        GTEventCenter.DelHandler<string>(GTEventID.TYPE_LOGIN_RANDOM_NAME, OnRecvRandomName);
    }
    ...
    private void OnCreateRoleClick(GameObject go)
    {
        ...
        GTNetworkSend.Instance.TryCreateRole(name, mRoleDB.Carrer, MLLogin.Instance.LastAccountID);
    }
    ...
    private void OnRecvRandomName(string name)
    {
        iptHeroName.value = name;
    }
    ...
    private void ShowModel()
    {
        ...
        DRole db = mRoleDBList[mRoleIndex];
        mPlayer = GTWorld.Instance.AddActorForDisplay(db.ActorID);
        mPlayer.Get<ActorAvator>().ChangeAvatar(8, db.DisplayWeapon);
    ...
    private void ShowRandomName()
    {
        ...
        if (role == null)
        {
            int sex = mRoleDB.Carrer == 2 || mRoleDB.Carrer == 3 ? 1 : 0;
            //GTNetworkSend.Instance.TryGetRandomName(sex);
            OnRecvRandomName(GetRandomName(sex));
        }
    }
