...
public class UIDialogue : GTWindow
{
    ...
    protected override void OnClose()
    {
        ...
        if (dlgAvatar != null)
        {
            GTResourceManager.Instance.DestroyObj(dlgAvatar.GetRootObj());
            dlgAvatar = null;
        }
    }
    ...
    private void ShowDialogueModel(DDialogue db)
    {
        ...
        dlgRenderer.AttachModel(dlgAvatar.GetRootObj());
