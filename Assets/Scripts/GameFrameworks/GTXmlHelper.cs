...
public static class GTXmlHelper
{
    ...
    public static List<float>  GetListForFloat(this XmlElement element, string name)
    {
        ...
        {
            float v = 0;
            float.TryParse(array[i], out v);
            list.Add(v);
        }
        return list;
    }

    public static List<EItem> GetListForItem(this XmlElement element, string name)
    {
