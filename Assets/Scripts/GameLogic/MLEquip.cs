...
//         return x2.Pos - x1.Pos;
    ...
    public bool IsFullStrengthenLevel(EquipItem equip)
    {
        return equip.StrengthLvl >= GetMaxEquipStrengthLevel(equip.EquipID);
    }

    public bool IsFullAdvanceLevel(EquipItem equip)
    {
        return equip.RefineLevel >= GetMaxEquipAdvanceLevel(equip.EquipID);
    }

    public bool IsFullStarLevel(EquipItem equip)
    {
        return equip.StarLevel > GetMaxEquipStarLevel(equip.EquipID);
    }

    public bool IsCanAsMatToAutoAdd(XItem item)
    {
        return true;// equipDB.Quality < 3;
    }
...
//         return mAllStrengthenMatList;
    ...
    public List<XItem> GetBagSameEquipList(EquipItem equip)
    {
...
//         return list;
    ...
    public List<XItem> GetItemListToOneKeyStrengthen(EquipItem equip)
    {
//         List<XItem> list = new List<XItem>();
...
//         int moneyNum = GTData.Instance.GetItemCountById(DEquip.EQUIP_STRENGTHEN_MONEY_ID_2);
//         if (moneyNum > 0)
//         {
